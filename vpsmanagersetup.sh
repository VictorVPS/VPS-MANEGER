...
apt-get update -y
apt-get upgrade -y
rm /bin/criarusuario /bin/expcleaner /bin/sshlimiter /bin/addhost /bin/listar /bin/sshmonitor /bin/ajuda /bin/slowssl /bin/slowssh > /dev/null
...
then
	...
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://raw.githubusercontent.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/sshmonitor2.sh -O /bin/sshmonitor
...
if [ -d "/etc/squid/" ]
then
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/payload.txt -O /etc/squid/payload.txt
	echo " " >> /etc/squid/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/2/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/2/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/sshmonitor2.sh -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/slowssh.sh -O /bin/slowssh
	chmod +x /bin/slowssh
wget https://github.com/VictorVPS/VPS-MANEGER/vpsmanager/scripts/slowssl.sh -O /bin/slowssl
	chmod +x /bin/slowssl
