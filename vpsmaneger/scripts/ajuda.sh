...
tput setaf 2 ; tput bold ; printf '%s' "slowssh" ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Arquivo ja completo para conexão slow dns direct na vivo." ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "slowssl" ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Arquivo ja completo para conexão slow dns ssl na vivo." ; echo "
tput setaf 2 ; tput bold ; printf '%s' "Extra" ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Mini tutorial para instalação digite instalar." ; echo "
tput sgr0